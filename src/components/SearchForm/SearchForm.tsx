          ...
          {filteredCities.map((city) => (
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm font-medium text-gray-500">{city.displayCode}</div>
              </div>
            </div>
          ))}
        </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-4xl">
        <h1 className="text-3xl lg:text-4xl font-light text-center mb-8">Flights</h1>
        ...
        <div className="bg-white rounded-lg shadow-lg p-4 lg:p-6">
          ...
          {/* Main search form */}
          <div className="flex flex-col lg:flex-row lg:items-center gap-4 mb-6 bg-gray-50 rounded-lg p-4">
            <div className="flex items-center gap-2 flex-1">
              ...
              <button onClick={handleSwapDestinations} className="p-2 hover:bg-gray-200 rounded-full flex-shrink-0">
